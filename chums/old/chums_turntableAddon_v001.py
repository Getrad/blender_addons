...
chm_renderroot = 'Y:/projects/CHUMS_Onsite/renders/assets/'
chm_assetworkfiles = '30_texture/projects/blender/workfiles'
chm_assetturntables = '30_texture/projects/blender/turntables'
thecam_name = "cam.ttCamera"
turntable_filepath = "Y:/projects/CHUMS_Onsite/_prod/assets/helpers/turntable/projects/blender/turntable_v011.blend"
vsn = '0.0.3'
...
def get_asset(asset_name):
    ...
    the_asset_dir = os.path.join(chm_assetroot,the_asset_type,asset_name,chm_assetworkfiles)
...
def get_asset_list():
    ...
    for asset_type in chm_assettypes:
        ...
        for asset in assets:
            ...
            this_asset_path = os.path.join(asset_type_path,asset,chm_assetworkfiles)
...
class BUTTON_OT_set_out_filepath(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        theoutpath = set_output_path(assetname)
...
class BUTTON_OT_save_ttfile(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        save_tt_file(bpy.context.scene.assetname)
        return{'FINISHED'}
...
def unregister():
    ...
    del bpy.types.Scene.ttutils_overscan
