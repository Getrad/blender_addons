                        ...
                        for mod in brush_obj.modifiers:
                            ...
                            if mod.type == 'MESH_SEQUENCE_CACHE':
                                ...
                                if not(mod.cache_file in cachefiles):
                                    ...
                                    print("OFFSET ", brush_obj.name, " TO ", mod.cache_file.frame_offset)
...
for o in bpy.data.objects:
    if len(o.modifiers) > 0 and o.modifiers[0].type == 'MESH_SEQUENCE_CACHE':
        o.modifiers[0].cache_file.frame_offset = 0
        print("OFFSET ", o.name, " TO ", o.modifiers[0].cache_file.frame_offset)
