...
removeRef("env_mooseRiver_01_scene_maRN")
        
def importRef():
    # grossly hardcoded for the moment :(
    newEnvPath = r"Y:/projects/CHUMS/_prod/_shotgrid/chums_season_1/assets/Environment/env_eastclearing/RIG/publish/maya/scene.v003.ma"
    # Replace with the desired namespace
    namespace = "env_eastclearing_scene_ma"
