...
canvases = ['env.loonbeach:ground_canvas']
...
for this_canvas in canvases:
    ...
    dp_canvas_mod.canvas_settings.canvas_surfaces[0].uv_layer = "map10"
    dp_canvas_mod.canvas_settings.canvas_surfaces[0].use_output_a = True
    dp_canvas_mod.canvas_settings.canvas_surfaces[0].output_name_a = (cache.name.replace('_mayaCache','')[:-6] + '_' + this_pass + '_')
