...
canvases = ['env.loonbeach:ground_canvas_10']
...
shots = {'010':10,'020':223,'030':10,'040':103,'050':126}
...
for this_canvas in canvases:
    ...
    dp_canvas_mod.canvas_settings.canvas_surfaces[0].image_fileformat = 'OPENEXR'
